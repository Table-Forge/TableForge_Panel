...
export const SkeletonTable = () => {
  return (
    <div className="flex w-full flex-col gap-6 select-none">
      ...
      <div className="chamfer-md border border-white/10 bg-card p-4 animate-pulse">
      ...
      <div className="overflow-hidden chamfer-md border border-white/10 bg-card p-6 animate-pulse">
        {/* Table Header Row */}
