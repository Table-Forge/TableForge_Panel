...
export const Button: React.FC<IButton> = ({
  ...
  const baseStyles =
    "inline-flex items-center justify-center gap-2 h-12 px-5 rounded-2xl border text-xs font-bold uppercase tracking-wider transition";
  ...
  return (
    <button
      className={[baseStyles, widthStyles, variants[buttonStyle], interactionStyles, className].join(" ")}
