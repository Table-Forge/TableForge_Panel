...
export function BrandName({ className = "", sizeClassName = "text-4xl" }: BrandNameProps) {
  return (
    ...
    >
      <span className="text-white [text-shadow:0_0_10px_rgba(248,248,248,0.25)]">Table</span>
      <span className="text-tertiary [text-shadow:0_0_24px_rgba(251,69,1,0.55)]">Forge</span>
    </h1>
  );
}
